...
import BaseTable, { Column,callOrReturn } from 'react-base-table'
...
const columns = [{key:"yolo",dataKey:"yolo",title:"yolo",width:100}];
const data = [{yolo:"polo"}];
columns[0].minWidth = 150

export default function Kurcina(props){
    return (<div>
     
        <DraggableTable columns={columns} data={data} width={100}/>
    </div>);
}
