...
//moje
                let updateColor = false,updateBackgroundColor=false;
                if(this.lastColor!=undefined){
                if(h.r!=this.lastColor.r || h.g!=this.lastColor.g || h.b!=this.lastColor.b) updateColor=true;
                if(r.r!=this.lastColor.r || r.g!=this.lastColor.g || r.b!=this.lastColor.b) updateBackgroundColor=true;
                }
                this.lastColor = h;
                this.lastBackgroundColor=r;
                if(updateBackgroundColor || updateColor){
                    const ss = (new n.Color(this.options.color)),
                    rr = (new n.Color(this.options.backgroundColor));
                    const v1 =  0.299 * ss.r + 0.587 * ss.g + 0.114 * ss.b;
                    const v2 =  0.299 * rr.r + 0.587 * rr.g + 0.114 * rr.b;
                    this.blending = v1 > v2 ? "additive" : "subtractive";                     
                    this.linesMesh.material.blending=("additive" === this.blending ? n.AdditiveBlending : n.NormalBlending);
                }
            ...
            for (let t = 0; t < this.points.length; t++) {
              ...
              for (let c = t; c < this.points.length; c++) {
                const t = this.points[c],
                  ...
                  if(updateColor){
                      t.material.color.set(h);//TITI change
                  }
                if (
