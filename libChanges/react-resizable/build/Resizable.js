...
function (_React$Component) {
  ...
  _proto.renderResizeHandle = function renderResizeHandle(resizeHandle) {
    ...
    let additionalStyle ={};
    const scaleHandler = this.props.scaleHandler;
    if(scaleHandler!=undefined) additionalStyle = {transform:"scale("+scaleHandler+")",marginRight:scaleHandler*10+"px",marginBottom:scaleHandler*10+"px"};
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        scaleHandler= _this$props.scaleHandler,
        ...
        p = _objectWithoutPropertiesLoose(_this$props, ["children", "draggableOpts", "scaleHandler","width", "height", "handleSize", "lockAspectRatio", "axis", "minConstraints", "maxConstraints", "onResize", "onResizeStop", "onResizeStart", "resizeHandles", "transformScale"]);
