...
var ReactGridLayout = /*#__PURE__*/function (_React$Component) {
  ...
  /*: void*/
  {
    ...
    (0, _utils.autoBindHandlers)(_assertThisInitialized(_this), ["onDragStart", "onDrag","onMouseDown", "onMouseUp","onDragStop", "onResizeStart", "onResize", "onResizeStop"]);
    return _this;
  }
  ...
  _createClass(ReactGridLayout, [{
    ...
    value: function containerHeight() {
      ...
      if(this.props.stretchContainer) nbRow = this.props.maxRows;
      var containerPaddingY = this.props.containerPadding ? this.props.containerPadding[1] : this.props.margin[1];
      var height = nbRow * this.props.rowHeight + (nbRow - 1) * this.props.margin[1] + containerPaddingY * 2 + "px";
      return height;
    }
    /**
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      if(this.props.preventMove) draggable=false;
