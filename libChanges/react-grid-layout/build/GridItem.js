  ...
  function GridItem() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onMouseDown", function (e
      /*: Event*/
        ...
        return onMouseDown.call(_assertThisInitialized(_this), e);
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "onMouseUp", function (e
        /*: Event*/
          ...
          if (!onMouseUp) return;
          return onMouseUp.call(_assertThisInitialized(_this), e);
        });
    ...
    , _ref2) {
      ...
      if (!onDrag) return;
     //deltaX  /= transformScale;//TITI CHANGE
     //deltaY /= transformScale;//TITI CHANGE
