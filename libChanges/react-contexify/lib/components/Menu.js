...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.componentDidUpdate = function (_, prevState) {
           //TITI CHANGE
        if(this.state.propsFromTrigger.cellData && 
            prevState.propsFromTrigger.cellData &&
            this.state.propsFromTrigger.cellData.i!=prevState.propsFromTrigger.cellData.i){
               this.props.onHidden(prevState.propsFromTrigger);
        }
        //TITI CHANGE
        if(this.state.x!=prevState.x || this.state.y!=prevState.y){
            if(this.props.onShown){
                this.props.onShown(this.state.propsFromTrigger);
            }
        ...
        if (this.state.visible !== prevState.visible) {
            if (this.state.visible && this.props.onShown) {
                ...
                this.props.onHidden(this.state.propsFromTrigger);
            }
        }
    };
